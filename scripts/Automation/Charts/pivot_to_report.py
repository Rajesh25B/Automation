'''
This module is a combination of previous scripts and it
automates conversion of a pivot table to excel report.
'''
...
# Putting together #2, #3, and #4
# (input: pivot_table.xlsx + month , output: Report with barchart,
# formulas and format)
now = datetime.now()
...
categories = Reference(sheet, min_col=min_column, max_col=min_column,
                       min_row=min_row+1, max_row=max_row)  # not including headers # noqa
