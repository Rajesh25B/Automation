'''
This module converts .py file into an executable file using pyinstaller
package and builds two folders build and dist.
'''
...
# Create a path for the executable.
# Preparing script before we convert it to executable
application_path = os.path.dirname(sys.executable)

# Putting together #2, #3, and #4
# (input: pivot_table.xlsx + month , output:
# Report with barchart, formulas and format)
